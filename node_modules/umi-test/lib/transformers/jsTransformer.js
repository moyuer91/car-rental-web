...
module.exports = _babelJest.default.createTransformer({
  ...
  plugins: [[require.resolve('babel-plugin-module-resolver'), {
    alias: {
      ...
      enzyme: (0, _umiUtils.compatDirname)('enzyme/package.json', cwd, require.resolve('enzyme')),
      'enzyme-adapter-react-16': (0, _umiUtils.compatDirname)('enzyme-adapter-react-16/package.json', cwd, require.resolve('enzyme-adapter-react-16'))
    }
  }, 'umi-test']]
});